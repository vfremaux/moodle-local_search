...
require_once "{$CFG->dirroot}/local/search/Zend/Search/Lucene/Search/Query.php";

/** Zend_Search_Lucene_Search_Weight_MultiTerm */
require_once "{$CFG->dirroot}/local/search/Zend/Search/Lucene/Search/Weight/MultiTerm.php";
