...
require_once "{$CFG->dirroot}/local/search/Zend/Search/Lucene/Search/QueryEntry/Term.php";

/** Zend_Search_Lucene_Search_QueryEntry_Phrase */
require_once "{$CFG->dirroot}/local/search/Zend/Search/Lucene/Search/QueryEntry/Phrase.php";

/** Zend_Search_Lucene_Search_QueryEntry_Subquery */
require_once "{$CFG->dirroot}/local/search/Zend/Search/Lucene/Search/QueryEntry/Subquery.php";
