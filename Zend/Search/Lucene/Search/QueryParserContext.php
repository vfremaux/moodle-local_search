...
require_once "{$CFG->dirroot}/local/search/Zend/Search/Lucene/Search/QueryToken.php";
...
require_once "{$CFG->dirroot}/local/search/Zend/Search/Lucene/Search/BooleanExpressionRecognizer.php";

/** Zend_Search_Lucene_Search_QueryEntry */
require_once "{$CFG->dirroot}/local/search/Zend/Search/Lucene/Search/QueryEntry.php";
