...
require_once $CFG->dirroot.'/local/search/Zend/Search/Lucene/Storage/Directory.php';

/** Zend_Search_Lucene_Storage_File_Filesystem */
require_once $CFG->dirroot.'/local/search/Zend/Search/Lucene/Storage/File/Filesystem.php';
