...
require_once $CFG->dirroot.'/local/search/Zend/Search/Lucene/Document.php';

/** Zend_Search_Lucene_Document_Html */
require_once $CFG->dirroot.'/local/search/Zend/Search/Lucene/Document/Html.php';

/** Zend_Search_Lucene_Storage_Directory_Filesystem */
require_once $CFG->dirroot.'/local/search/Zend/Search/Lucene/Storage/Directory/Filesystem.php';

/** Zend_Search_Lucene_Storage_File_Memory */
require_once $CFG->dirroot.'/local/search/Zend/Search/Lucene/Storage/File/Memory.php';

/** Zend_Search_Lucene_Index_Term */
require_once $CFG->dirroot.'/local/search/Zend/Search/Lucene/Index/Term.php';

/** Zend_Search_Lucene_Index_TermInfo */
require_once $CFG->dirroot.'/local/search/Zend/Search/Lucene/Index/TermInfo.php';

/** Zend_Search_Lucene_Index_SegmentInfo */
require_once $CFG->dirroot.'/local/search/Zend/Search/Lucene/Index/SegmentInfo.php';

/** Zend_Search_Lucene_Index_FieldInfo */
require_once $CFG->dirroot.'/local/search/Zend/Search/Lucene/Index/FieldInfo.php';

/** Zend_Search_Lucene_Index_Writer */
require_once $CFG->dirroot.'/local/search/Zend/Search/Lucene/Index/Writer.php';

/** Zend_Search_Lucene_Search_QueryParser */
require_once $CFG->dirroot.'/local/search/Zend/Search/Lucene/Search/QueryParser.php';

/** Zend_Search_Lucene_Search_QueryHit */
require_once $CFG->dirroot.'/local/search/Zend/Search/Lucene/Search/QueryHit.php';

/** Zend_Search_Lucene_Search_Similarity */
require_once $CFG->dirroot.'/local/search/Zend/Search/Lucene/Search/Similarity.php';
...
if (!empty($CFG->block_search_softlock)){
    require_once $CFG->dirroot.'/local/search/Zend/Search/Lucene/SoftLockManager.php';
} else {
    require_once $CFG->dirroot.'/local/search/Zend/Search/Lucene/LockManager.php';
}



/** Zend_Search_Lucene_Interface */
require_once $CFG->dirroot.'/local/search/Zend/Search/Lucene/Interface.php';

/** Zend_Search_Lucene_Proxy */
require_once $CFG->dirroot.'/local/search/Zend/Search/Lucene/Proxy.php';
